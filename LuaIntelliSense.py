# Add Lua autocompletion to find matches in all lua files in projects. 
# By default, Sublime only considers words from the current file.

# todo: 
# 1.parser method should be down in some days
# 2.accelerate the search speed to find the match
...
class LuaIntelliSense(sublime_plugin.EventListener):
